...
export const getEventCard = ({eventItem, startDate, endDate, cost, offers}) => {
  ...
  <div class="event">
    <div class="event__type">
      <img class="event__type-icon" width="42" height="42" src=${eventItem.eventIcon} alt="Event type icon">
    </div>
    <h3 class="event__title">${eventItem.eventTitle}${eventItem.destination}</h3>
