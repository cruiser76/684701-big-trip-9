  ...
  <form class="event  event--edit" action="#" method="post">
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--time">
        ...
        <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${eventStartTime.getDate()}/${eventStartTime.getMonth() + 1}/${eventStartTime.getFullYear().toString().slice(2)} ${eventStartTime.getHours()}:${eventStartTime.getMinutes()}">
        &mdash;
        <label class="visually-hidden" for="event-end-time-1">
          To
        </label>
        <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${eventEndTime.getDate()}/${eventEndTime.getMonth() + 1}/${eventEndTime.getFullYear().toString().slice(2)} ${eventEndTime.getHours()}:${eventEndTime.getMinutes()}">
      </div>
